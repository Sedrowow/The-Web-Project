...
var characterList = ['SAS', 'Best Teacher', 'Schobi(er)', 'IF-IS-NO-LOOP', 'if-schleife.de', 'if schober=here: be happy', '2+2=5'];
...
var layers = {
    ...
    color: ['#f00', '#e00', '#c00', '#b00', '#a00'], //color of the letters (starting from the deepest layer)
    font: 'Times New Roman' //font family (of every layer)
};
